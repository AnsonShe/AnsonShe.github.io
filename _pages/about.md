...
I am currently a graduate student at the [University of Science and Technology of China (USTC)](https://en.ustc.edu.cn/), where I am fortunate to be advised by Prof. [Weiming Zhang](https://faculty.ustc.edu.cn/zhangweiming/en/index.htm) and Prof. [Kejiang Chen](https://faculty.ustc.edu.cn/chenkejiang/en/index.htm). My research centers on **AI Security & Multimedia Forensics**, with a current focus on **AI-generated content (AIGC) forensics**, and the **security of large models**.
...
On this homepage you can find my research, publications, and honors. Broadly, I am interested in adversarial machine learning, ownership verification of DNNs, multimedia forensics, and the trustworthiness of generative models. I have been lucky to collaborate with [Yan Cai](https://cyccyyycyc.github.io/), [Weifeng Liu](https://aaroncomo.github.io/), and [Boheng Li](https://antigonerandy.github.io/).


# 🔥 News
- *2026.05*: 🎉 One paper on **LipSync forgery detection & attribution** accepted by **ICML 2026**.
- *2025.09*: I received an entrance scholarship from the University of Science and Technology of China.
